...
Source0  : https://download.kde.org/stable/release-service/24.05.1/src/kcharselect-24.05.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.1/src/kcharselect-24.05.1.tar.xz.sig
...
%setup -q -n kcharselect-24.05.1
cd %{_builddir}/kcharselect-24.05.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718412858
mkdir -p clr-build
pushd clr-build
