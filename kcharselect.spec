...
Source0  : https://download.kde.org/stable/release-service/21.04.2/src/kcharselect-21.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.04.2/src/kcharselect-21.04.2.tar.xz.sig
...
%prep
%setup -q -n kcharselect-21.04.2
cd %{_builddir}/kcharselect-21.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1623368452
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kcharselect-21.04.2/COPYING %{buildroot}/usr/share/package-licenses/kcharselect/7c203dee3a03037da436df03c4b25b659c073976
pushd clr-build
%make_install
popd
