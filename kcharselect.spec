...
Source0  : https://download.kde.org/stable/release-service/24.02.0/src/kcharselect-24.02.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.0/src/kcharselect-24.02.0.tar.xz.sig
...
%prep
%setup -q -n kcharselect-24.02.0
cd %{_builddir}/kcharselect-24.02.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709276463
mkdir -p clr-build
pushd clr-build
