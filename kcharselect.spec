...
Source0  : https://download.kde.org/stable/release-service/23.08.0/src/kcharselect-23.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.0/src/kcharselect-23.08.0.tar.xz.sig
...
%prep
%setup -q -n kcharselect-23.08.0
cd %{_builddir}/kcharselect-23.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1693027540
mkdir -p clr-build
pushd clr-build
