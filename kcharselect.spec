...
Version  : 22.08.1
Release  : 43
URL      : https://download.kde.org/stable/release-service/22.08.1/src/kcharselect-22.08.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.1/src/kcharselect-22.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.1/src/kcharselect-22.08.1.tar.xz.sig
...
%prep
%setup -q -n kcharselect-22.08.1
cd %{_builddir}/kcharselect-22.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662827659
mkdir -p clr-build
pushd clr-build
