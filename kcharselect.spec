...
Source0  : https://download.kde.org/stable/release-service/21.12.1/src/kcharselect-21.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.12.1/src/kcharselect-21.12.1.tar.xz.sig
...
%prep
%setup -q -n kcharselect-21.12.1
cd %{_builddir}/kcharselect-21.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641960361
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kcharselect-21.12.1/COPYING %{buildroot}/usr/share/package-licenses/kcharselect/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/kcharselect-21.12.1/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/kcharselect/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
cp %{_builddir}/kcharselect-21.12.1/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kcharselect/3e8971c6c5f16674958913a94a36b1ea7a00ac46
pushd clr-build
%make_install
popd
